...
/*!
 * \brief 根据cond(ition)决定执行成功还是失败.
 *
 * \param pTest test case object.
 * \param str   test function's name.
 * \param cond  whether the function succeed.
 * \param file  in which the function.
 * \param line  on which the function.
 */
void ct_do_test(
    Test * pTest,
    const char *str,
